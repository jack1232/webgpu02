...
const CreateTriangle = (color = '(1.0,1.0,1.0,1.0)') => __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    ...
    const shader = shaders_1.Shaders(color);
...
CreateTriangle();
jquery_1.default('#id-btn').on('click', () => {
    const color = jquery_1.default('#id-color').val();
